...
BASE_MASTER_PROMPT = (
    ...
    "When an audio player, transcript review, speech-to-text task, or spoken Bengali/English segment is presented:\n"
    ...
    "  - Prepend transcript with speaker tag: (Speaker 1). If multi-speaker turn, tag inline: (Speaker 1) ... (Speaker 2) ...\n"
    ...
    "  - Spoken Spelling: All uppercase separated by spaces: 'T I R E L L Y' (NO hyphens).\n"
    "  - Punctuation rules: Allowed: . , ? ! \" ' - —. STRICTLY FORBIDDEN: NO colons (:) or semicolons (;).\n"
    "  - Punctuate by intonation (rising pitch = ? even without question words).\n"
    "  - Incomplete words get hyphens (জা- জানা- জানাথন), full word repetitions get NO hyphens (একটা একটা একটা), cutoffs get trailing em-dash (—).\n"
    "  - Elongated words: Spell normally (Peeeeerfect -> Perfect | হ্যালোওওও -> হ্যালো).\n"
    "  - Standard words: OK, 'cause, All right, Whoa. Contractions: don't, gonna. Dropped sounds: chilling (NOT chillin').\n"
